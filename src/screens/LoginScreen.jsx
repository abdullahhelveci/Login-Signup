...
const LoginScreen = () => {
  ...
  return (
    ...
    <View className='flex items-center'>
        <Animated.Text entering={FadeInDown.duration(1000)} className='text-black font-bold tracking-wider text-5xl'>Login</Animated.Text>
    </View>
        ...
        className='flex items-center mx-4 space-y-5'>
